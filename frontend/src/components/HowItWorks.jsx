...
function HowItWorks() {
  ...
  return (
       ...
       className="md:py-30 md:px-30 py-16 px-5 text-center ">
        ...
        <div className='flex flex-col md:flex-row  justify-center items-center md:gap-30 gap-5 mt-20'>
              <motion.img 
        animate={{y:[0,20,0]}}
        transition={{duration:5, repeat:Infinity}} src="https://i.ibb.co/Qjmy86zb/7546977-3671751.jpg" alt="" className='w-[450px]  order-2 md:order-1'/>
        ...
        <div className='flex flex-col md:flex-row justify-center items-center md:gap-30 gap-5 mt-20'>
         ...
         <motion.img 
        animate={{y:[0,20,0]}}
        transition={{duration:5, repeat:Infinity}} src="https://i.ibb.co/ksffmT5N/7372901-3643906.jpg" alt="" className='w-[450px]'/>
        </div>
...
{/* {["Request a Ride", "Get Matched with a Driver", "Track & Arrive Safely"].map((step, i) => (
